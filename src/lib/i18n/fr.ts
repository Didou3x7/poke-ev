...
export const fr: Dict = {
  ...
  meta: {
    home: {
      ...
      description:
        "Calculateur d'Expected Value pour displays, boosters et ETB Pokémon TCG. Taux de pull documentés × prix Cardmarket du jour : verdict OUVRE ou GARDE, marge et probabilité de profit.",
    },
    calculator: {
      title: "Calculateur d'EV Pokémon TCG · display, booster, ETB | Poké EV",
      description:
        "Entre ton prix d'achat, choisis ton set : EV à l'ouverture, verdict OUVRE/GARDE, top cartes, contribution par rareté et probabilité de profit. Prix Cardmarket FR actualisés.",
    },
    sets: {
      title: "Tous les sets Pokémon TCG avec EV · catalogue complet FR/EN | Poké EV",
      description:
        "Catalogue complet des extensions Pokémon TCG de 1999 à aujourd'hui, noms français et anglais, avec Expected Value courant pour les sets aux taux de pull documentés.",
    },
    set: {
